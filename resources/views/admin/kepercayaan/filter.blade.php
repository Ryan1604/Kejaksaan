...
@section('title', 'Pengawasan Kepercayaan Masyarakat')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Pengawasan Kepercayaan Masyarakat</h1>
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">
                        ...
                        Pengawasan Kepercayaan Masyarakat
                    </div>
                </div>
            </div>
            ...
            <div class="section-body">
                <div class="card card-primary">  
                    <div class="card-body">
                        <form action="{{ route('admin.kepercayaan.download') }}" method="POST">
                            @csrf
                            <div class="row">
