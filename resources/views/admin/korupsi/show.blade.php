...
@section('title', 'Detail Tindak Pidana Korupsi')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Detail Tindak Pidana Korupsi</h1>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-md">
                                ...
                                <tr>
                                    <td>Penyelidikan</td>
                                    <td>{{ $data->penyelidikan }}</th>
                                </tr>
                                <tr>
                                    <td>Penyidikan</td>
                                    <td>Kejaksaan: 
                                        <?php
                                            if ($data->tgl_surat_kejaksaan == NULL) {
                                                echo '-';
                                            } else {
                                                echo date('d M Y', strtotime($data->tgl_surat_kejaksaan)) . ' / ' . $data->nomor_surat_kejaksaan;
                                            }
                                        ?> 
                                    </th>
                                </tr>
                                <tr>
                                    ...
                                    <td>Polri: 
                                        <?php
                                            if ($data->tgl_surat_polri == NULL) {
                                                echo '-';
                                            } else {
                                                echo date('d M Y', strtotime($data->tgl_surat_polri)) . ' / ' . $data->nomor_surat_polri;
                                            }
                                        ?> 
                                    </th>
                                </tr>
