...
@section('title', 'Tindak Pidana Korupsi')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Tindak Pidana Korupsi</h1>
            ...
            <div class="section-body">
                <form method="POST" action="{{ route('admin.korupsi.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        ...
                                                        <input type="date" class="form-control form-control-sm" name="tgl_surat_kejaksaan" id="tgl_surat_kejaksaan" value="{{ old('tgl_surat_kejaksaan') }}">   
                                                        <br>
                                                        <input type="text" class="form-control form-control-sm" name="nomor_surat_kejaksaan" id="nomor_surat_kejaksaan" value="{{ old('nomor_surat_kejaksaan') }}" placeholder="Masukkan Nomor Surat Kejaksaan">   
                                                    </div>
                                                    <div class="col-md-6 col-sm-6">
                                                        <label>Polri</label>
                                                        <input type="date" class="form-control form-control-sm" name="tgl_surat_polri" id="tgl_surat_polri" value="{{ old('tgl_surat_polri') }}"> 
                                                        <br>
                                                        <input type="text" class="form-control form-control-sm" name="nomor_surat_polri" id="nomor_surat_polri" value="{{ old('nomor_surat_polri') }}" placeholder="Masukkan Nomor Surat Polri"> 
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
