            ...
            <div class="section-body">
                <div class="card card-primary">  
                    <div class="card-header">
                        <a class="btn btn-primary" href="{{ route('admin.korupsi.filter') }}">
                            <i class="fas fa-print"></i>
                            Download
                        </a>
                        <a class="btn btn-primary ml-auto" href="{{ route('admin.korupsi.create') }}">
                ...
                swal("Peringatan!", "Apakah anda yakin?", "warning", {
                    ...
                    switch (value) {
                        case "ok" :
                            $.ajax({
                                type: "DELETE",
                                url: '{{ route('admin.korupsi.index') }}' + '/' + id,
