...
@section('title', 'Edit Tindak Pindana Korupsi')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Tindak Pindana Korupsi</h1>
            ...
            <div class="section-body">
                <form method="POST" action="{{ route('admin.korupsi.update', $data->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="card card-success">
                                <div class="card-header">
                                    <h4 class="card-title">Tambah Tindak Pidana Korupsi</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="penyelidikan">Penyelidika</label>
                                                <input type="text" class="form-control form-control-sm @error('penyelidikan') is-invalid @enderror" name="penyelidikan" id="penyelidikan" value="@error('penyelidikan'){{ old('penyelidikan') }}@else{{ $data->penyelidikan }}@enderror" placeholder="Masukkan Penyelidikan">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label>Penyidikan</label>
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <label>Kejaksaan</label>
                                                        <input type="date" class="form-control form-control-sm" name="tgl_surat_kejaksaan" id="tgl_surat_kejaksaan" value="@error('tgl_surat_kejaksaan'){{ old('tgl_surat_kejaksaan') }}@else{{ $data->tgl_surat_kejaksaan }}@enderror">   
                                                        <br>
                                                        <input type="text" class="form-control form-control-sm" name="nomor_surat_kejaksaan" id="nomor_surat_kejaksaan" value="@error('nomor_surat_kejaksaan'){{ old('nomor_surat_kejaksaan') }}@else{{ $data->nomor_surat_kejaksaan }}@enderror" placeholder="Masukkan Nomor Surat Kejaksaan">   
                                                    </div>
                                                    <div class="col-md-6 col-sm-6">
                                                        <label>Polri</label>
                                                        <input type="date" class="form-control form-control-sm" name="tgl_surat_polri" id="tgl_surat_polri" value="@error('tgl_surat_polri'){{ old('tgl_surat_polri') }}@else{{ $data->tgl_surat_polri }}@enderror"> 
                                                        <br>
                                                        <input type="text" class="form-control form-control-sm" name="nomor_surat_polri" id="nomor_surat_polri" value="@error('nomor_surat_polri'){{ old('nomor_surat_polri') }}@else{{ $data->nomor_surat_polri }}@enderror" placeholder="Masukkan Nomor Surat Polri"> 
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm @error('penuntutan') is-invalid @enderror" name="penuntutan" id="penuntutan" value="@error('penuntutan'){{ old('penuntutan') }}@else{{ $data->penuntutan }}@enderror" placeholder="Masukkan Penuntutan">
