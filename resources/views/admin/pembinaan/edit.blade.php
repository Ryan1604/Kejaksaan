                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="waktu">Waktu <sup class="text-danger">*</sup></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="tempat">Tempat <sup class="text-danger">*</sup></label>
                                                <input type="text" class="form-control form-control-sm @error('tempat') is-invalid @enderror" name="tempat" id="tempat" value="@error('tempat'){{ old('tempat') }}@else{{ $data->tempat }}@enderror" placeholder="Masukkan Tempat">
