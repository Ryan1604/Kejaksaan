...
@section('title', 'Detail Pembinaan Masyarakat Taat Hukum')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Detail Pembinaan Masyarakat Taat Hukum</h1>
                        ...
                        <div class="table-responsive">
                            <table class="table table-md">
                                ...
                                <tr>
                                    ...
                                    <td>{{ date('d M Y', strtotime($data->waktu)) }}, {{ $data->tempat }}</th>
                                </tr>
                                <tr>
                                    <td>Materi</td>
                                    <td>{{ $data->materi }}</th>
