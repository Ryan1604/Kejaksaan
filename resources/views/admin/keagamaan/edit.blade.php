...
@section('title', 'Edit Pengawasan Aliran Keagamaan')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Pengawasan Aliran Keagamaan</h1>
            ...
            <div class="section-body">
                <form method="POST" action="{{ route('admin.keagamaan.update', $data->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-lg-9">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h4 class="card-title">Edit Pengawasan Aliran Keagamaan</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="nama">Nama Aliran Keagamaan <sup class="text-danger">*</sup></label>
                                                <input type="text" class="form-control form-control-sm @error('nama') is-invalid @enderror" name="nama" id="nama" value="@error('nama'){{ old('nama') }}@else{{ $data->nama }}@enderror" placeholder="Masukkan Nama Aliran Keagamaan">
