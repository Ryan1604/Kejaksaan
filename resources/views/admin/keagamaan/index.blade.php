            ...
            <div class="section-body">
                <div class="card card-primary">  
                    <div class="card-header">
                        <a class="btn btn-primary" href="{{ route('admin.keagamaan.filter') }}">
                            <i class="fas fa-print"></i>
                            Download
                        </a>
                        <a class="btn btn-primary ml-auto" href="{{ route('admin.keagamaan.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#ebook-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin.keagamaan.index') }}',
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                ...
                swal("Peringatan!", "Apakah anda yakin?", "warning", {
                    ...
                    switch (value) {
                        case "ok" :
                            $.ajax({
                                type: "DELETE",
                                url: '{{ route('admin.keagamaan.index') }}' + '/' + id,
