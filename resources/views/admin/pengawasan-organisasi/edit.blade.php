...
@section('title', 'Edit Pengawasan Organisasi Kemasyarakatan')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Pengawasan Organisasi Kemasyarakatan</h1>
            ...
            <div class="section-body">
                <form method="POST" action="{{ route('admin.pengawasan_organisasi.update', $data->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-lg-9">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h4 class="card-title">Edit Pengawasan Organisasi Kemasyarakatan</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="nama">Nama Organisasi Kemasyarakatan <sup class="text-danger">*</sup></label>
                                                <input type="text" class="form-control form-control-sm @error('nama') is-invalid @enderror" name="nama" id="nama" value="@error('nama'){{ old('nama') }}@else{{ $data->nama }}@enderror" placeholder="Masukkan Nama Organisasi Kemasyarakatan">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control form-control-sm @error('akta') is-invalid @enderror" name="akta" id="akta" value="@error('akta'){{ old('akta') }}@else{{ $data->akta }}@enderror">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm @error('alamat') is-invalid @enderror" name="alamat" id="alamat" value="@error('alamat'){{ old('alamat') }}@else{{ $data->alamat }}@enderror" placeholder="Masukkan Domisili / Alamat">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm @error('pengurus') is-invalid @enderror" name="pengurus" id="pengurus" value="@error('pengurus'){{ old('pengurus') }}@else{{ $data->pengurus }}@enderror" placeholder="Masukkan Nama Pengurus">
