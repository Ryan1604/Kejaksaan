...
@section('title', 'Pengawasan Organisasi Masyarakat')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Pengawasan Organisasi Masyarakat</h1>
            ...
            <div class="section-body">
                <div class="card card-primary">  
                    <div class="card-body">
                        <form action="{{ route('admin.pengawasan_organisasi.download') }}" method="POST">
                            @csrf
                            <div class="row">
