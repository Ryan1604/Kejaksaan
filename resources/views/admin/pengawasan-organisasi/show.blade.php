...
@section('title', 'Detail Pengawasan Organisasi Kemasyarakatan')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Detail Pengawasan Organisasi Kemasyarakatan</h1>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-md">
                                ...
                                <tr>
                                    <td>Nama Organisasi Kemasyarakatan</td>
                                    <td>{{ $data->nama }}</th>
                                </tr>
                                <tr>
                                    <td>Kedudukan atau Status</td>
                                    <td>{{ $data->status }}</th>
                                </tr>
                                <tr>
                                    <td>Berdiri Sejak atau Akta Pendirian</td>
                                    <td>{{ date('d M Y', strtotime($data->akta)) }}</th>
                                </tr>
                                <tr>
