...
@section('title', 'Edit Posko Perwakilan Kejaksaan')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Posko Perwakilan Kejaksaan</h1>
            ...
            <div class="section-body">
                <form method="POST" action="{{ route('admin.posko.update', $data->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-lg-9">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h4 class="card-title">Edit Posko Perwakilan Kejaksaan</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="posko">Posko Perwakilan <sup class="text-danger">*</sup></label>
                                                <input type="text" class="form-control form-control-sm @error('posko') is-invalid @enderror" name="posko" id="posko" value="@error('posko'){{ old('posko') }}@else{{ $data->posko }}@enderror" placeholder="Masukkan Posko Perwakilan">
                                                <div class="invalid-feedback" id="valid-posko">{{ $errors->first('posko') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="masalah">Temuan / Permasalahan <sup class="text-danger">*</sup></label>
                                                <input type="text" class="form-control form-control-sm @error('masalah') is-invalid @enderror" name="masalah" id="masalah" value="@error('masalah'){{ old('masalah') }}@else{{ $data->masalah }}@enderror" placeholder="Masukkan Temuan / Permasalahan">
                                                <div class="invalid-feedback" id="valid-masalah">{{ $errors->first('masalah') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
