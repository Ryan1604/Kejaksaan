                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm @error('jenis_media') is-invalid @enderror" name="jenis_media" id="jenis_media" value="{{ old('jenis_media') }}" placeholder="Masukkan Bentuk Media Komunikasi">
