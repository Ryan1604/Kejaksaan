...
@section('title', 'Pengawasan Barang Media Komunikasi')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Pengawasan Barang Media Komunikasi</h1>
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">
                        ...
                        Pengawasan Barang Media Komunikasi
                    </div>
                </div>
            </div>
            ...
            <div class="section-body">
                <div class="card card-primary">  
                    <div class="card-body">
                        <form action="{{ route('admin.pengawasan_media.download') }}" method="POST">
                            @csrf
                            <div class="row">
