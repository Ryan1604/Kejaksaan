            ...
            <table class="table table-sm table-bordered" id="report">
                <thead class="table">
                    <tr class="text-center text-wrap" style="width: 8rem">
                        <th style="font-size: 14px;position: relative;padding-bottom: 20px;;" rowspan="2">No</th>
                        <th style="font-size: 14px;position: relative;padding-bottom: 20px;;" rowspan="2">IDENTITAS</th>
                        <th style="font-size: 14px;position: relative;padding-bottom: 20px;;" rowspan="2">PERMOHONAN PENCEGAHAN ATAU PENANGKALAN NO./TGL</th>
                        <th style="font-size: 14px;position: relative;padding-bottom: 20px;;" rowspan="2">KASUS POSISI DAN PASAL YANG DISANGKAKAN/ DIDAKWAKAN PUTUSAN PENGADILAN</th>
                        <th style="font-size: 14px;position: relative;padding-bottom: 20px;;" rowspan="2">KEPJA R.I NO./TGL</th>
                        <th colspan="2">CEGAH ATAU TANGKAL</th>
                        <th style="font-size: 14px;position: relative;padding-bottom: 20px;;" rowspan="2">KETERANGAN</th>
                    </tr>
                    <tr>
                ...
                @if (count($data) > 0)
                    ...
                    <tbody>
                        <tr height="40px" align="justify">
                            <td>{{ $no++ }}</td>
                            <td>{{ $item->biodata->name }}</td>
                            <td>{{  $item->nomor_pencegahan }} / {{ $item->tgl_pencegahan }}</td>
                            <td style="word-break: break-all">{{ $item->pasal }}</td>
