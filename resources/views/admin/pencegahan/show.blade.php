...
@section('title', 'Detail Pencegahan dan Penangkalan')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Detail Pencegahan dan Penangkalan</h1>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-md">
                                ...
                                <tr>
                                    <td>Permohonan Pencegahan atau Penangkalan</td>
                                    <td>{{ $data->nomor_pencegahan }}/{{ date('d M Y', strtotime($data->tgl_pencegahan)) }}</th>
                                </tr>
                                <tr>
                                    <td>Kasus Posisi dan Pasal yang disangkakan</td>
                                    <td>{{ $data->pasal }}</th>
                                </tr>
                                <tr>
                                    <td>Kepja R.I</td>
                                    <td>{{ $data->nomor_kepja }}/{{ date('d M Y', strtotime($data->tgl_kepja)) }}</th>
                                </tr>
                                <tr>
                                    <td>Cegah atau Tangkal</td>
                                    <td>Tanggal Mulai: {{ date('d M Y', strtotime($data->tgl_mulai)) }}</th>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>Tanggal Akhir: {{ date('d M Y', strtotime($data->tgl_akhir)) }}</th>
                                </tr>
                                <tr>
                                    <td>Keterangan</td>
