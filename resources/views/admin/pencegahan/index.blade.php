    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Pencegahan dan Penangkalan</h1>
            ...
            <div class="section-body">
                <div class="card card-primary">  
                    <div class="card-header">
                        <a class="btn btn-primary" href="{{ route('admin.pencegahan.filter') }}">
                            <i class="fas fa-print"></i>
                            Download
                        </a>
                        <a class="btn btn-primary ml-auto" href="{{ route('admin.pencegahan.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#ebook-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin.pencegahan.index') }}',
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
