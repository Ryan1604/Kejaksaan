...
@section('title', 'Detail Ketertiban dan Ketentraman Umum')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Detail Ketertiban dan Ketentraman Umum</h1>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-md">
                                ...
                                <tr>
                                    <td>Direktorat / Kejati / Kejari / Cabjari</td>
                                    <td>{{ $data->direktorat }}</th>
                                </tr>
                                <tr>
                                    <td>Jenis Masalah</td>
                                    <td>{{ $data->jenis_masalah }}</th>
                                </tr>
                                <tr>
                                    <td>Pokok Permasalahan</td>
                                    <td>{{ $data->pokok_permasalahan }}</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Informasi yang diperoleh</td>
                                    <td>{{ $data->info }}</th>
                                </tr>
                                <tr>
                                    <td>Trend Perkembangan</td>
                                    <td>{{ $data->perkembangan }}</th>
                                </tr>
                                <tr>
                                    <td>Penyelesaian</td>
                                    <td>{{ $data->penyelesaian }}</th>
                                </tr>
                                <tr>
                                    <td>Keterangan</td>
