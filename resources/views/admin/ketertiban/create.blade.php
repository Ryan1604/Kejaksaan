    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Ketertiban dan Ketentraman Umum</h1>
            ...
            <div class="section-body">
                <form method="POST" action="{{ route('admin.ketertiban.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h4 class="card-title">Tambah Ketertiban dan Ketentraman Umum</h4>
                                </div>
                                <div class="card-body">
