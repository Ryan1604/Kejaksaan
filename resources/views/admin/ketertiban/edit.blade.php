...
@section('title', 'Edit Ketertiban dan Ketentraman Umum')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Ketertiban dan Ketentraman Umum</h1>
            ...
            <div class="section-body">
                <form method="POST" action="{{ route('admin.ketertiban.update', $data->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-lg-9">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h4 class="card-title">Edit Ketertiban dan Ketentraman Umum</h4>
                                </div>
                                <div class="card-body">
