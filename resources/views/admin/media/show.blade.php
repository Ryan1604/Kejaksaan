        ...
        <div class="container fs-6 text-sm py-1 px-5 mx-1">
            <div class="row">
                ...
                <div class="row col-12">
                    ...
                    <div class="row">
                        <div class="col-7 px-4">2. &emsp; Nama/NPWP pemsahaan media komuaikasi</div>
                        <div class="col-1">:</div>
                        <div class="col-5"></div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-7 px-4">7. &emsp; Penanggungjawab mediakomunikasi</div>
                        <div class="col-1">:</div>
                        <div class="col-5"></div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-7 px-4">10. &emsp; Jumlah peredaran media komunikasi</div>
                        <div class="col-1">:</div>
                        <div class="col-5"></div>
                    </div>
                    <br />
