    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Kartu TIK Pengawasan Media Komunikasi</h1>
            ...
            <div class="section-body">
                <div class="card card-primary">  
                    <div class="card-header">
                        <a class="btn btn-primary ml-auto" href="{{ route('admin.media.create') }}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-hover" id="ebook-table">
                                <thead class="thead-light">
                                    <tr>
                                        <th>No</th>
                                        <th>Nama Media Komunikasi</th>
                                        <th>Jenis Usaha Media Komunikasi</th>
                                        <th>Alamat Perusahaan Media Komunikasi</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                            </table>
                ...
                swal("Whoops!", "Apakah anda yakin?", "warning", {
                    ...
                    switch (value) {
                        case "ok" :
                            $.ajax({
                                type: "DELETE",
                                url: '{{ route('admin.media.index') }}' + '/' + id,
