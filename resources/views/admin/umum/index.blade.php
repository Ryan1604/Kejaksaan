...
@section('title', 'Tindak Pidana Umum')
            ...
            <div class="section-body">
                <div class="card card-primary">  
                    <div class="card-header">
                        <a class="btn btn-primary" href="{{ route('admin.umum.filter') }}">
                            <i class="fas fa-print"></i>
                            Download
                        </a>
                        <a class="btn btn-primary ml-auto" href="{{ route('admin.umum.create') }}">
