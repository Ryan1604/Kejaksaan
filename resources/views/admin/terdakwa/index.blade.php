    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Kartu TIK Tersangka/Terdakwa/Terpidana</h1>
            ...
            <div class="section-body">
                <div class="card card-primary">  
                    <div class="card-header">
                        <a class="btn btn-primary ml-auto" href="{{ route('admin.terdakwa.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#ebook-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin.terdakwa.index') }}',
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                ...
                swal("Peringatan!", "Apakah anda yakin?", "warning", {
                    ...
                    switch (value) {
                        case "ok" :
                            $.ajax({
                                type: "DELETE",
                                url: '{{ route('admin.terdakwa.index') }}' + '/' + id,
