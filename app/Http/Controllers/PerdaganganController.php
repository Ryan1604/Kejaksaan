...
class PerdaganganController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Perdagangan::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.perdagangan.biodata')
                ->addColumn('kecamatan', 'admin.perdagangan.kecamatan')
                ->addColumn('action', 'admin.perdagangan.action')
        ...
        return view('admin.perdagangan.index', compact('kecamatan', 'biodata'));
    }
    ...
    {
        $data = Perdagangan::findOrFail($id);
