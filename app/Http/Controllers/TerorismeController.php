...
class TerorismeController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Terorisme::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.terorisme.biodata')
                ->addColumn('kecamatan', 'admin.terorisme.kecamatan')
                ->addColumn('action', 'admin.terorisme.action')
        ...
        return view('admin.terorisme.index', compact('kecamatan', 'biodata'));
    }
