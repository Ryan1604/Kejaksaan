...
class MinyakController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Minyak::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.minyak.biodata')
                ->addColumn('kecamatan', 'admin.minyak.kecamatan')
                ->addColumn('action', 'admin.minyak.action')
        ...
        return view('admin.minyak.index', compact('kecamatan', 'biodata'));
    }
