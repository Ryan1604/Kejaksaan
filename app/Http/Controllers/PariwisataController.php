...
class PariwisataController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Pariwisata::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.pariwisata.biodata')
        ...
        return view('admin.pariwisata.index', compact('kecamatan', 'biodata'));
    }
