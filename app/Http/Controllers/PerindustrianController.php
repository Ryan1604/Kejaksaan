...
class PerindustrianController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Perindustrian::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.perindustrian.biodata')
                ->addColumn('kecamatan', 'admin.perindustrian.kecamatan')
                ->addColumn('action', 'admin.perindustrian.action')
        ...
        return view('admin.perindustrian.index', compact('kecamatan', 'biodata'));
    }
    ...
    {
        $data = Perindustrian::findOrFail($id);
