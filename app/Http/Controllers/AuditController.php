...
class AuditController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Audit::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.audit.biodata')
                ->addColumn('kecamatan', 'admin.audit.kecamatan')
                ->addColumn('action', 'admin.audit.action')
        ...
        return view('admin.audit.index', compact('kecamatan', 'biodata'));
    }
