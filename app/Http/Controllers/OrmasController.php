...
class OrmasController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Ormas::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.ormas.biodata')
                ->addColumn('kecamatan', 'admin.ormas.kecamatan')
                ->addColumn('action', 'admin.ormas.action')
        ...
        return view('admin.ormas.index', compact('kecamatan', 'biodata'));
    }
