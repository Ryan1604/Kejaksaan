...
class KeuanganNegaraController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(KeuanganNegara::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.keuangan.biodata')
                ->addColumn('kecamatan', 'admin.keuangan.kecamatan')
                ->addColumn('action', 'admin.keuangan.action')
        ...
        return view('admin.keuangan.index', compact('kecamatan', 'biodata'));
    }
    ...
    {
        $data = KeuanganNegara::findOrFail($id);
    ...
    {
        $data = KeuanganNegara::destroy($id);
