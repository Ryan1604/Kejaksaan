...
class PakemController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Pakem::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.pakem.biodata')
                ->addColumn('kecamatan', 'admin.pakem.kecamatan')
                ->addColumn('action', 'admin.pakem.action')
        ...
        return view('admin.pakem.index', compact('kecamatan', 'biodata'));
    }
