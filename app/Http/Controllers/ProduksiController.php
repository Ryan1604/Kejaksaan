...
class ProduksiController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Produksi::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.produksi.biodata')
                ->addColumn('kecamatan', 'admin.produksi.kecamatan')
                ->addColumn('action', 'admin.produksi.action')
        ...
        return view('admin.produksi.index', compact('kecamatan', 'biodata'));
    }
