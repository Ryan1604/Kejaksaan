...
class LembagaKeuanganController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(LembagaKeuangan::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.lembaga.biodata')
                ->addColumn('kecamatan', 'admin.lembaga.kecamatan')
                ->addColumn('action', 'admin.lembaga.action')
        ...
        return view('admin.lembaga.index', compact('kecamatan', 'biodata'));
    }
    ...
    {
        $data = LembagaKeuangan::findOrFail($id);
    ...
    {
        $data = LembagaKeuangan::destroy($id);
