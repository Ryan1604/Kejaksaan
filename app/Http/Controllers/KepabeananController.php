...
class KepabeananController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Kepabeanan::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.kepabeanan.biodata')
                ->addColumn('kecamatan', 'admin.kepabeanan.kecamatan')
                ->addColumn('action', 'admin.kepabeanan.action')
        ...
        return view('admin.kepabeanan.index', compact('kecamatan', 'biodata'));
    }
