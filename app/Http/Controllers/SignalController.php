...
class SignalController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Signal::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.signal.biodata')
                ->addColumn('kecamatan', 'admin.signal.kecamatan')
                ->addColumn('action', 'admin.signal.action')
        ...
        return view('admin.signal.index', compact('kecamatan', 'biodata'));
    }
