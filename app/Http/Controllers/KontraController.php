...
class KontraController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Kontra::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.kontra.biodata')
                ->addColumn('kecamatan', 'admin.kontra.kecamatan')
                ->addColumn('action', 'admin.kontra.action')
        ...
        return view('admin.kontra.index', compact('kecamatan', 'biodata'));
    }
