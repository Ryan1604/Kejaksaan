...
class InfrastrukturController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Infrastruktur::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.infrastruktur.biodata')
        ...
        return view('admin.infrastruktur.index', compact('kecamatan', 'biodata'));
    }
