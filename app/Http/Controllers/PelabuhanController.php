...
class PelabuhanController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Pelabuhan::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.pelabuhan.biodata')
        ...
        return view('admin.pelabuhan.index', compact('kecamatan', 'biodata'));
    }
