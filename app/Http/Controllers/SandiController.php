...
class SandiController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Sandi::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.sandi.biodata')
                ->addColumn('kecamatan', 'admin.sandi.kecamatan')
                ->addColumn('action', 'admin.sandi.action')
        ...
        return view('admin.sandi.index', compact('kecamatan', 'biodata'));
    }
