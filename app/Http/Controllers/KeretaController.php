...
class KeretaController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Kereta::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.kereta.biodata')
                ->addColumn('kecamatan', 'admin.kereta.kecamatan')
                ->addColumn('action', 'admin.kereta.action')
        ...
        return view('admin.kereta.index', compact('kecamatan', 'biodata'));
    }
