...
class CukaiController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Cukai::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.cukai.biodata')
                ->addColumn('kecamatan', 'admin.cukai.kecamatan')
                ->addColumn('action', 'admin.cukai.action')
        ...
        return view('admin.cukai.index', compact('kecamatan', 'biodata'));
    }
