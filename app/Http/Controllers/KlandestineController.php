...
class KlandestineController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Klandestine::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.klandestine.biodata')
                ->addColumn('kecamatan', 'admin.klandestine.kecamatan')
                ->addColumn('action', 'admin.klandestine.action')
        ...
        return view('admin.klandestine.index', compact('kecamatan', 'biodata'));
    }
    ...
    {
        $data = Klandestine::findOrFail($id);
