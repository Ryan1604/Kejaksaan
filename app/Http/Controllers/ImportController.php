...
class ImportController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Import::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.import.biodata')
                ->addColumn('kecamatan', 'admin.import.kecamatan')
                ->addColumn('action', 'admin.import.action')
        ...
        return view('admin.import.index', compact('kecamatan', 'biodata'));
    }
