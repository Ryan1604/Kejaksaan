...
class TelekomunikasiController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Telekomunikasi::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.telekomunikasi.biodata')
                ->addColumn('kecamatan', 'admin.telekomunikasi.kecamatan')
                ->addColumn('action', 'admin.telekomunikasi.action')
        ...
        return view('admin.telekomunikasi.index', compact('kecamatan', 'biodata'));
    }
    ...
    {
        $data = Telekomunikasi::findOrFail($id);
    ...
    {
        $data = Telekomunikasi::destroy($id);
