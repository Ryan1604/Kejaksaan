...
class BarcetController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Barcet::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.barcet.biodata')
                ->addColumn('kecamatan', 'admin.barcet.kecamatan')
                ->addColumn('action', 'admin.barcet.action')
        ...
        return view('admin.barcet.index', compact('kecamatan', 'biodata'));
    }
