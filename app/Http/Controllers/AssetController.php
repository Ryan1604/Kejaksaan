...
class AssetController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Asset::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.asset.biodata')
                ->addColumn('kecamatan', 'admin.asset.kecamatan')
                ->addColumn('action', 'admin.asset.action')
        ...
        return view('admin.asset.index', compact('kecamatan', 'biodata'));
    }
