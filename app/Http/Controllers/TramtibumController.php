...
class TramtibumController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(Tramtibum::with('kecamatan', 'biodata')
                ->orderBy('updated_at', 'DESC')
                ->get())
                ->addColumn('biodata', 'admin.tramtibum.biodata')
                ->addColumn('kecamatan', 'admin.tramtibum.kecamatan')
                ->addColumn('action', 'admin.tramtibum.action')
        ...
        return view('admin.tramtibum.index', compact('kecamatan', 'biodata'));
    }
